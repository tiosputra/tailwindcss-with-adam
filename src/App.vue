    ...
    <div class="bg-gray-100 flex">
      ...
      >
        <div class="xl:max-w-lg xl:ml-auto">
          ...
          <h1
            class="mt-6 text-2xl font-black text-gray-900 leading-tight sm:text-4xl sm:mt-8 lg:text-3xl xl:text-4xl"
          >
          ...
          <p class="mt-2 text-gray-600 sm:mt-4 sm:text-xl">
            Workcation helps you find work-friendly rentails in beautiful
